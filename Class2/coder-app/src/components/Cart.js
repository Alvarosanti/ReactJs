...
const Cart = () => {
	...
	const { items, removeItem, removeAllItems, precioTotal } = useCartContext();
									...
									<div class="row">
										<div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
											<div id="cartTable" class="table-responsive">
												<div align="center">
													<h3 class="lead mb-4">
														No tienes art&iacute;culos en el carro de compras. ¡Vamos de
														compras!
													</h3>
													<Link to="/" class="btn btn-outline-dark">
														<a>Empieza a comprar</a>
													</Link>
												</div>
											</div>
										</div>
						...
						<div class="row py-5 p-4 bg-white rounded shadow-sm">
							<div class="col-lg-12">
								...
								<div class="p-4">
									...
									<Link to={'/checkout'} class="btn btn-dark rounded-p2 py-2 btn-block">
